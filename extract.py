...
line, and uses the resulting collections to build an
`NEODatabase`.
...
def load_neos(neo_csv_path):
    ...
    with open(neo_csv_path, 'r') as csv_file:
        ...
        for row in reader:
            ...
            neos.append(NearEarthObject(designation, name, diameter,
                                        hazardous))
...
def load_approaches(cad_json_path):
    ...
    with open(cad_json_path, 'r') as json_file:
        ...
        for close_approach in data['data']:

            designation = close_approach[0]
            time = close_approach[3]
            distance = close_approach[4]
            velocity = close_approach[7]
